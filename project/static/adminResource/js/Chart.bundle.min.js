    ...
    return function e(t, n, i) {
        ...
        1: [function (t, e, n) {
            ...
            !function (e, a) {
                ...
                function v(t, e) {
                    var n, i, a;
                    if (p(e._isAMomentObject) || (t._isAMomentObject = e._isAMomentObject), p(e._i) || (t._i = e._i), p(e._f) || (t._f = e._f), p(e._l) || (t._l = e._l), p(e._strict) || (t._strict = e._strict), p(e._tzm) || (t._tzm = e._tzm), p(e._isUTC) || (t._isUTC = e._isUTC), p(e._offset) || (t._offset = e._offset), p(e._pf) || (t._pf = f(e)), p(e._locale) || (t._locale = e._locale), vi.length > 0) for (n in vi) i = vi[n], a = e[i], p(a) || (t[i] = a);
                    return t
                }
                ...
                function pe(t) {
                    var e = t._i, n = t._f;
                    return t._locale = t._locale || ne(t._l), null === e || void 0 === n && "" === e ? m({nullInput: !0}) : ("string" == typeof e && (t._i = e = t._locale.preparse(e)), y(e) ? new b(ae(e)) : (a(n) ? fe(t) : s(e) ? t._d = e : n ? ce(t) : ve(t), g(t) || (t._d = null), t))
                }
                ...
                var ki, Si = {
                    ...
                    Fi = /(\[[^\[]*\])|(\\)?(LTS|LT|LL?L?L?|l{1,4})/g, Ii = {}, Oi = {}, Ri = /\d/, Wi = /\d\d/,
                    Li = /\d{3}/, Vi = /\d{4}/, Bi = /[+-]?\d{6}/, Yi = /\d\d?/, zi = /\d\d\d\d?/, Ni = /\d\d\d\d\d\d?/,
                    Hi = /\d{1,3}/, Ei = /\d{1,4}/, Ui = /[+-]?\d{1,6}/, ji = /\d+/, Gi = /[+-]?\d+/,
                ...
                var ma = "Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"),
                    pa = "Sun_Mon_Tue_Wed_Thu_Fri_Sat".split("_"), va = "Su_Mo_Tu_We_Th_Fr_Sa".split("_"), ba = Xi,
                    ya = Xi, xa = Xi;
                ...
                var Ja = Math.abs, Xa = oi("ms"), Ka = oi("s"), Qa = oi("m"), $a = oi("h"), to = oi("d"), eo = oi("w"),
                    ...
                    fo = {s: 45, m: 45, h: 22, d: 26, M: 11}, go = Math.abs, mo = we.prototype;
                    ...
                    dataElementType: t.elements.Arc, linkScales: e.noop, getRingIndex: function (t) {
                        ...
                        if (f < 2 * Math.PI) {
                            ...
                            var m = g + f, p = {x: Math.cos(g), y: Math.sin(g)}, v = {x: Math.cos(m), y: Math.sin(m)},
                                ...
                                }, M = {width: .5 * (_.x - w.x), height: .5 * (_.y - w.y)};
                            d = Math.min(s / M.width, l / M.height), u = {x: (_.x + w.x) * -.5, y: (_.y + w.y) * -.5}
                        }
                ...
                t.defaults.line = {
                    ...
                    updateElement: function (t, e, i) {
                        var a, o, r = this, s = r.getMeta(), l = t.custom || {}, d = r.getDataset(), u = r.index,
                            ...
                            g = r.chart.options.elements.point, m = r.chart.data.labels || [],
                ...
                t.layoutService = {
                    defaults: {}, addBox: function (t, e) {
                        ...
                        if (t) {
                            ...
                            var m = n - 2 * l, p = i - 2 * d, v = m / 2, b = p / 2, y = (n - v) / (u.length + c.length),
                                x = (i - b) / (h.length + f.length), k = m, S = p, w = [];
                ...
                t.defaults.global.legend = {
                    ...
                    initialize: function (t) {
                        ...
                        var n = this, i = n.options, a = i.labels, o = i.display, r = n.ctx, s = t.defaults.global,
                            ...
                            h = e.fontString(d, u, c), f = n.legendHitBoxes = [], g = n.minSize, m = n.isHorizontal();
                        if (m ? (g.width = n.maxWidth, g.height = o ? 10 : 0) : (g.width = o ? 10 : 0, g.height = n.maxHeight), o) if (r.font = h, m) {
                        ...
                        if (i.display) {
                            var d, u = n.ctx, c = e.getValueOrDefault, h = c(a.fontColor, o.defaultFontColor),
                                ...
                                m = c(a.fontFamily, o.defaultFontFamily), p = e.fontString(f, g, m);
                ...
                t.defaults.scale = {
                    ...
                    fit: function () {
                        var n = this, i = n.minSize = {width: 0, height: 0}, a = n.options, o = t.defaults.global,
                            ...
                            m = e.getValueOrDefault(s.fontSize, o.defaultFontSize), p = a.gridLines.tickMarkLength;
                    ...
                    draw: function (n) {
                        ...
                        if (a.display) {
                            ...
                            var m = e.getValueOrDefault(d.fontColor, l.defaultFontColor),
                                ...
                                b = e.getValueOrDefault(d.fontFamily, l.defaultFontFamily), y = e.fontString(p, v, b),
                                ...
                                D = e.getValueOrDefault(c.fontFamily, l.defaultFontFamily), C = e.fontString(_, M, D),
                                T = e.toRadians(i.labelRotation), P = Math.cos(T), A = i.longestLabelWidth * P;
                            s.fillStyle = m;
                            var F = [];
                            if (g) {
                                if (o = !1, h && (A /= 2), (A + d.autoSkipPadding) * i.ticks.length > i.width - (i.paddingLeft + i.paddingRight) && (o = 1 + Math.floor((A + d.autoSkipPadding) * i.ticks.length / (i.width - (i.paddingLeft + i.paddingRight)))), r && i.ticks.length > r) for (; !o || i.ticks.length / (o || 1) > r;) o || (o = 1), o += 1;
                                f || (o = !1)
                            }
                            ...
                            if (e.each(i.ticks, function (t, r) {
                                ...
                                if (u.display && (s.save(), s.lineWidth = t.glWidth, s.strokeStyle = t.glColor, s.setLineDash && (s.setLineDash(t.glBorderDash), s.lineDashOffset = t.glBorderDashOffset), s.beginPath(), u.drawTicks && (s.moveTo(t.tx1, t.ty1), s.lineTo(t.tx2, t.ty2)), u.drawOnChartArea && (s.moveTo(t.x1, t.y1), s.lineTo(t.x2, t.y2)), s.stroke(), s.restore()), d.display) {
                                    ...
                                    var n = t.label;
                                    if (e.isArray(n)) for (var i = 0, a = 0; i < n.length; ++i) s.fillText("" + n[i], 0, a), a += 1.5 * p; else s.fillText(n, 0, 0);
                                    s.restore()
                                }
                            }), c.display) {
                                var L, V, B = 0;
                ...
                t.defaults.global.tooltips = {
                    ...
                    initialize: function () {
                        ...
                        var i, o, r, s, l, d, u = this._view, c = this._chart.ctx, h = u.caretSize, f = u.cornerRadius,
                            g = u.xAlign, m = u.yAlign, p = t.x, v = t.y, b = e.width, y = e.height;
                ...
                var e = t.helpers, n = t.defaults.global, i = {
                    ...
                    getValueCount: function () {
                        ...
                        var t, i, a, o, r, s, l, d, u, c, h, f, g = this.options.pointLabels,
                            ...
                            v = e.getValueOrDefault(g.fontFamily, n.defaultFontFamily), b = e.fontString(m, p, v),
                        ...
                        if (i.display) {
                            ...
                            if (e.each(t.ticks, function (r, s) {
                                ...
                                for (var g = t.getDistanceFromCenterForValue(i.reverse ? t.min : t.max), m = l(s.fontSize, n.defaultFontSize), p = l(s.fontStyle, n.defaultFontStyle), v = l(s.fontFamily, n.defaultFontFamily), b = e.fontString(m, p, v), y = t.getValueCount() - 1; y >= 0; y--) {
                                    ...
                                    var w = t.pointLabels, _ = this.getIndexAngle(y) + Math.PI / 2,
